# Movies Browser  <span align="center">
  <img alt="Movies Browser" src="/public/tmdb-long.svg" width="18%" />
</span> ![The Movie Database](/public/tmdb-long.svg)
...
The movie browser is a project created to allow you to browse the currently popular movies and popular actors. In addition, we can check information about each movie and actor. The browser is based on the TMDB database, which is updated daily.

## How it works

![Movies Browser](public/moviesBrowser.gif)
